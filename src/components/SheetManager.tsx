...
export function SheetManager() {
  ...
  /** Titles of tabs the user chose to hide — passed to Airtable log */
  const [hiddenTabTitles, setHiddenTabTitles] = useState<string[]>([]);
  ...
  const handleTabsHidden = (hiddenTitles: string[]) => {
    setHiddenTabTitles(hiddenTitles);
    setStep(3);
  };
      ...
      <div className="app-bg">
        ...
        <div className="app-header">
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", marginBottom: "8px" }}>
            ...
            <h1 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "clamp(24px, 5vw, 30px)", fontWeight: 800, color: "#1c1917", letterSpacing: "-0.03em" }}>
              Sheet Manager
            </h1>
          </div>
          <p style={{ fontSize: "14.5px", color: "#78716c", maxWidth: "460px", margin: "0 auto", lineHeight: 1.55 }}>
              ...
              <div className="card-body">
                    ...
                    {step > 1 && (
                      <button
                        ...
                        style={{
                          ...
                          color: "#78716c", fontSize: "12px", fontWeight: 600,
                          cursor: isLoading ? "not-allowed" : "pointer",
                          opacity: isLoading ? 0.5 : 1, transition: "all 0.18s",
                ...
                {sheetName && step > 1 && (
                  <div className="context-strip" style={{ marginBottom: "20px" }}>
                    ...
                    <span style={{ fontSize: "12px", fontWeight: 600, color: "#6b7280" }}>Working on:</span>
                ...
                {/* Step panels */}
                {step === 1 && (
                  <CreateSheet onCreated={handleCreated} createSheet={createSheet} isLoading={isLoading} onToast={toast} />
                )}
                {step === 2 && createdSheet && (
                  <HideTabs tabs={createdSheet.tabs} spreadsheetId={createdSheet.spreadsheetId} hideTabs={hideTabs} isLoading={isLoading} onDone={handleTabsHidden} onToast={toast} />
                )}
                {step === 3 && createdSheet && (
                  <ShareSheet spreadsheetId={createdSheet.spreadsheetId} sheetName={sheetName} hiddenTabs={hiddenTabTitles} shareSheet={shareSheet} isLoading={isLoading} onToast={toast} />
                )}
              </div>
        ...
        <div className="app-footer">
          <p>Built with Next.js · Google Sheets API · Google Drive API · Airtable</p>
        </div>
